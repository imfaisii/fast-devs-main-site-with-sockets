                                    ...
                                    <div class="o_col o_col-2"
                                        ...
                                        <div class="o_px-xs o_sans o_text o_left o_xs-center"
                                            ...
                                            <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-primary"
                                                    ...
                                                    style="text-decoration: none;outline: none;color: #FFC107;"><img
                                                        src="images/logo.png" width="136" height="36"
                                                        alt="{{ env('APP_NAME') }}"
                                                        ...
                                                        <td class="o_btn-b o_heading o_text-xs" align="center"
                                                            ...
                                                            <a class="o_text-light" href="https://example.com/"
                                                                style="text-decoration: none;outline: none;color: #82899a;display: block;padding: 7px 8px;font-weight: bold;"><span
                                                                    style="mso-text-raise: 6px;display: inline;color: #82899a;">{{ env('APP_NAME') }}
                                                                </span> <img
                                                                    src="{{ asset('mail/images/person-24-light.png') }}"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_sans o_text o_text-white o_bg-primary o_px o_py o_br-max"
                                                    align="center"
                                                    style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #FFC107;color: #ffffff;border-radius: 96px;padding-left: 16px;padding-right: 16px;padding-top: 16px;padding-bottom: 16px;">
                                                    <img src="{{ asset('mail/images/check-48-white.png') }}"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Hello to the future !
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_re o_bg-primary o_px o_pb-md" align="center"
                                    style="font-size: 0;vertical-align: top;background-color: #FFC107;padding-left: 16px;padding-right: 16px;padding-bottom: 24px;">
                                    ...
                                    <div class="o_col o_col-3"
                                        ...
                                        <div class="o_px-xs o_sans o_text o_text-white o_left o_xs-center"
                                            ...
                                            <p class="o_mb-xxs" style="margin-top: 0px;margin-bottom: 4px;">
                                                <strong>Early Subscriber ! </strong> <span class="o_text-xxs"
                                                    ...
                                                    <tr>
                                                        <td class="o_btn o_bg-white o_br o_heading o_text"
                                                            ...
                                                            <a class="o_text-primary" href="https://example.com/"
                                                                style="text-decoration: none;outline: none;color: #FFC107;display: block;padding: 12px 24px;mso-text-raise: 3px;">Confirm
                                                                Subscription</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                        ...
                        <tbody>
                                ...
                                <td class="o_re o_bg-white o_px o_pb-lg o_bt-light" align="center"
                                    ...
                                    <div class="o_col o_col-2 o_col-full"
                                        ...
                                        <div class="o_px-xs o_sans o_text-xs o_center"
                                            ...
                                            <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-light"
                                                    href="https://example.com/"
                                            ...
                                            <p style="margin-top: 0px;margin-bottom: 0px;">
                                                <a class="o_text-light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #82899a;"><img
                                                        src="{{ asset('mail/images/facebook-light.png') }}" width="36"
                                                        height="36" alt="fb"
                                                ...
                                                <a class="o_text-light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #82899a;"><img
                                                        src="{{ asset('mail/images/twitter-light.png') }}" width="36"
                                                        height="36" alt="tw"
                                                        style="max-width: 36px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a><span>
                                                    &nbsp;</span>
                                                <a class="o_text-light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #82899a;"><img
                                                        src="{{ asset('mail/images/instagram-light.png') }}"
                                                        width="36" height="36" alt="ig"
                                                        style="max-width: 36px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a><span>
                                                    &nbsp;</span>
                                                <a class="o_text-light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #82899a;"><img
                                                        src="{{ asset('mail/images/snapchat-light.png') }}" width="36"
                                                        height="36" alt="sc"
                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_pb-lg o_br-b o_sans o_text-xs o_text-light"
                                    ...
                                    <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">©2021
                                        {{ env('APP_NAME') }} Pvt. Ltd<br>
                                        Address Here!
                                    </p>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">
                                        <a class="o_text-xxs o_text-light o_underline" href="https://example.com/"
                                            style="text-decoration: underline;outline: none;font-size: 12px;line-height: 19px;color: #82899a;">Unsubscribe</a>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
